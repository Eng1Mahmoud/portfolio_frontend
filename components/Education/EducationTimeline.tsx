            ...
            <div className="relative z-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <span className="mt-2 inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-3 py-1 text-sm font-medium text-ink-body">
                    <FaUniversity
              ...
              {Array.isArray(item.skills) && item.skills.length > 0 && (
                <ul className="flex flex-wrap gap-2">
                  {item.skills.map((skill) => (
                    <li
                      key={skill}
                      className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 font-mono text-[10px] text-ink-muted md:text-xs"
                    >
                      {skill}
                    </li>
                  ))}
